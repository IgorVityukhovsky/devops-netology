...
<details>
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "node_filesystem_avail_bytes {fstype=~\"ext4|xfs\"}",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Объём доступного пространства",
      "tooltip": {
        "shared": true,
        "sort": 0,
    ...
    },
    {
      "alert": {
        ...
        "frequency": "1m",
        "handler": 1,
        "message": "Не поступают метрики процессора с nodeexporter",
      ...
      "targets": [
        {
          "expr": "avg_over_time(node_load1{instance='nodeexporter:9100'}[1m])",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        },
        {
          "expr": "avg_over_time(node_load1{instance='nodeexporter:9100'}[5m])",
          "hide": false,
          "interval": "",
          "legendFormat": "",
          "refId": "B"
        ...
        {
          "expr": "avg_over_time(node_load1{instance='nodeexporter:9100'}[15m])",
          "hide": false,
          "interval": "",
          "legendFormat": "",
          "refId": "C"
